...
function initBigInteger1(packages) {
    ...
    Classic.prototype.toString = function () {
        return "Classic()";
    }
    ...
    Montgomery.prototype.toString = function () {
        return "Montgomery()";
    }
    ...
    BigInteger.prototype.modPowInt = function (e, m) {
        var z;
        if (e < 256 || m.isEven()) z = new BigInteger.Classic(m);
        else z = new BigInteger.Montgomery(m);
        return this.exp(e, z);
    };
