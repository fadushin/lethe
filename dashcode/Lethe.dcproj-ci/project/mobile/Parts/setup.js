...
var dashcodePartSpecs = {
    ...
    "KeyFingerprint": { "propertyValues": { "textBinding": { "keypath": "PeersList.selection.pubKey", "transformer": "pubKeyFingerprint" } }, "text": "54 C9 1C 74 81 00 37 38 83 DD 6E 7C 03 15 4E 49 4C 94 89 9E", "view": "DC.Text" },
    ...
    "PeerName": { "propertyValues": { "textBinding": { "keypath": "PeersList.selection.name" } }, "text": "Peer Name", "view": "DC.Text" },
    "PeerNameLabel": { "text": "Peer Name:", "view": "DC.Text" },
    ...
    "PeersList": { "allowsEmptySelection": true, "dataArray": ["Item 1", "Item 2", "Item 3"], "labelElementId": "label2", "listStyle": "List.ROUNDED_RECTANGLE", "propertyValues": { "dataArrayBinding": { "keypath": "ChannelList.selection.peers", "transformer": "filterIdentity" } }, "sampleRows": 3, "selectionEnabled": true, "useDataSource": true, "view": "DC.List" },
