...
var dashcodePartSpecs = {
    ...
    "ChannelSplitLayout": { "flexibleViewIndex": 1, "initialSize": 918, "initialSplitterSize": 10, "isVertical": true, "splitterPosition": 178, "view": "DC.SplitLayout" },
    ...
    "SignMessagesCheckbox": { "propertyValues": { "checkedBinding": { "keypath": "ChannelList.selection.signMessages" } }, "view": "DC.ToggleButton" },
    "input2": { "propertyValues": { "checkedBinding": { "keypath": "*.isTrusted" } }, "view": "DC.ToggleButton" },
    "EncryptToSelfCheckbox": { "propertyValues": { "checkedBinding": { "keypath": "ChannelList.selection.peers", "transformer": "atMostOneEncryptTo" } }, "view": "DC.ToggleButton" },
    ...
    "splitLayout": { "flexibleViewIndex": 1, "initialSize": 408, "initialSplitterSize": 10, "splitterPosition": 103, "view": "DC.SplitLayout" },
