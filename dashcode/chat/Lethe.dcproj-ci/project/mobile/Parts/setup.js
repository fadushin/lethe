...
var dashcodePartSpecs = {
    ...
    "AboutButton": { "initialHeight": 30, "initialWidth": 76, "leftImageWidth": 5, "onclick": "showAboutView", "rightImageWidth": 5, "text": "About", "view": "DC.PushButton" },
    "AboutDetail": { "propertyValues": { "htmlBinding": { "keypath": "AboutList.selection.text" } }, "text": "Text", "view": "DC.Text" },
    "AboutDoneButton": { "initialHeight": 30, "initialWidth": 72, "leftImageWidth": 5, "onclick": "showChannelsView", "rightImageWidth": 5, "text": "Done", "view": "DC.PushButton" },
    "AboutList": { "allowsEmptySelection": true, "dataArray": ["Item 1", "Item 2", "Item 3"], "labelElementId": "label1", "listStyle": "List.ROUNDED_RECTANGLE", "propertyValues": { "dataArrayBinding": { "keypath": "lethe.content.about.sections" } }, "sampleRows": 6, "selectionEnabled": true, "useDataSource": true, "view": "DC.List" },
    ...
    "ChannelStack": { "subviewsTransitions": [{ "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "dissolve" }, { "direction": "left-right", "duration": "", "timing": "ease-in-out", "type": "dissolve" }], "view": "DC.StackLayout" },
    ...
    "IdentityKeyFingerprintLabel1": { "propertyValues": { "textBinding": { "keypath": "lethe.content.identity.pubKey", "transformer": "pubKeyFingerprint" } }, "text": "54 C9 1C 74 81 00 37 38 83 DD 6E 7C 03 15 4E 49 4C 94 89 9E", "view": "DC.Text" },
    ...
    "input1": { "propertyValues": { "checkedBinding": { "keypath": "*.isTrusted" } }, "view": "DC.ToggleButton" },
    "input2": { "propertyValues": { "checkedBinding": { "keypath": "PeersList.selection.isTrusted" } }, "view": "DC.ToggleButton" },
    "input3": { "propertyValues": { "checkedBinding": { "keypath": "ChannelList.selection.peers.encryptTo" } }, "view": "DC.ToggleButton" },
    "input4": { "propertyValues": { "checkedBinding": { "keypath": "ChannelList.selection.peers.isTrusted" } }, "view": "DC.ToggleButton" },
    ...
    "SignMessagesCheckboxInput": { "propertyValues": { "checkedBinding": { "keypath": "ChannelList.selection.signMessages" } }, "view": "DC.ToggleButton" },
